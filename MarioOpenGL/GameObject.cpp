...
{
    renderer.DrawSprite(this->Sprite, this->Position + offsetPosition, this->Rois[this->RoiIdx]->RegionScale, this->Rois[this->RoiIdx]->OffsetScale, this->Size, this->Rotation, this->Color);
}
